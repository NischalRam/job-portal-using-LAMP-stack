...
if(isset($_POST['sf'])){
    ...
    $q="SELECT * FROM `signup` WHERE firstname = '$username' and password='$password'";
...
<div class="alert">
  ...
  <strong>ERROR!</strong> username or password are not mathching.
  </div>
        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" action="signin.php" method="post" class="form-horizontal" role="form">
                                    
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><br><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="login-username" type="text" class="form-control" name="username" value="" placeholder="username or email">                                        
                                    </div>
                                
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><br><i class="glyphicon glyphicon-lock"></i></span>
                            ...
                            <div class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <button name="sf" type="submit" id="btn-login" class="btn btn-success">Login  </button>
